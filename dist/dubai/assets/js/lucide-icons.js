...
// This approach uses the actual Lucide React icon SVGs without React
...
const lucideIcons = {
  ...
  'plane': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2-3v-3l5.5 5.5c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"/></svg>`,
  
  'building': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v8h20v-8a2 2 0 0 0-2-2h-2"/><path d="M18 9h1a2 2 0 0 1 2 2v11"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/></svg>`,
  ...
  'x': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="M6 6l12 12"/></svg>`,
...
function renderIcon(containerId, iconName, className = "w-4 h-4") {
  const container = document.getElementById(containerId);
  if (!container) return;

  const iconSvg = lucideIcons[iconName];
  if (!iconSvg) return;

  // Remove fixed width and height from SVG to allow CSS classes to work
  const modifiedSvg = iconSvg.replace(/width="[^"]*"/g, '').replace(/height="[^"]*"/g, '');
...
function renderIcons(iconConfigs) {
  iconConfigs.forEach(config => {
    renderIcon(config.containerId, config.iconName, config.className);
  });
}
